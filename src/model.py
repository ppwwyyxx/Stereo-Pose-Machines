...
def run_test(path):
    ...
    predict_func = OfflinePredictor(PredictConfig(
        ...
        input_names=['input'],
        output_names=['Mconv7_stage6/output']   # prob:0 is the probability distribution
    ))


    im = cv2.imread('cpmtest.jpg').astype('float32')/256.0 - 0.5    # bgr
